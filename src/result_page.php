...
?>
	<br>
	數值變異方式 : <select id="mutaton_select" name="mutaton_select" >
		<option value="1" selected="selected">全部欄位變異</option>
		<option value="3">個別欄位變異</option>
	</select>
	數值變異種類 : <select id="mutaton_mode" name="mutaton_mode" >
	...
	變異路徑最大數量 : <input type="number" value="5"  min="1" max="100" id="mutation_max" name="mutation_max" style="width: 40px;">
	</div>
		<!--<p id="string1">Test issue count indicator</p>-->
	<div id="download_container">
		<marquee   scrollamount="5"  id="marquee"><font id="marquee_string">資料處理中,請耐心等候,感謝您!</font></marquee>
   		...
   		<table  class="disable"id="state_information" border="1"  align="center" >
   		</table>
